...
14. Using the vertex attribute `people.names`, identify which individual is most central in the network.
15. What might their position in the network suggest about their role in this historical context?
16. Using the vertex attribute `place.names`, identify which location is most central in the network.
...
*Note*: for 14 and 16, you can access the vertex attribute using the `paul_revere_net %v% "people.names"` and `paul_revere_net %v% "place.names"`, respectively.
