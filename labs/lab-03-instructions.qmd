...
For the `london_gang_net` network, do the following:  
  ...
  10. Graph centralization is often used to assess how "star-like" a network is. What would a completely centralized network look like? What would its degree centrality scores be? Describe it (or, if your feeling feisty, create one and plot it!).
