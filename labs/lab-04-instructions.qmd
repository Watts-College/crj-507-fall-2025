...
For the `london_gang_net` network, do the following:  
  ...
  10. Graph centralization is often used to assess how "star-like" a network is. If we were examining closeness centrality, what would a completely centralized network look like? What would its closeness centrality scores be? Describe it (or, of your feeling fiesty, create one and plot it!).
  11. If we were examining betweenness centrality, what would a completely centralized network look like? What would its betweenness centrality scores be? Describe it (or, of your still feeling fiesty, create one and plot it!).
...
Then, answer:
  ...
  - Which node is most central by closeness?  
  - Which node is most central by betweenness?
